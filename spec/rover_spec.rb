...
describe Rover do
  ...
  describe 'Facing North' do
    let(:rover) { Rover.new(0, 4, 'N', Plateau.new(3, 4)) }
  ...
  describe 'Facing South' do  
    let(:rover) { Rover.new(0, 0, 'S', Plateau.new(3, 4)) }
  ...
  describe 'Facing East' do  
    let(:rover) { Rover.new(3, 0, 'E', Plateau.new(3, 4)) }
  ...
  describe 'Facing West' do  
    let(:rover) { Rover.new(0, 0, 'W', Plateau.new(3, 4)) }
